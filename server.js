...
const CACHE_VERSION = 8; // Bump to invalidate disk cache after schema changes
...
async function refreshAll() {
    ...
    refreshOne('meetings', odataEncode(`/Tasks?$filter=DateTime ge ${oneTwentyDaysAgo} and (startswith(Title,'Reuni') or startswith(Title,'reuni'))&$select=Id,Title,DateTime,OwnerId,CreatorId,DealId,ContactId,TypeId,Done,EndDate&$orderby=DateTime desc`));
